...
namespace Playfair
{
    ...
    {
        QString res = message;
        const QChar x = (this->currentAbc == Alphabet::EN) ? this->alphabetEn.at(22) : this->alphabetRu.at(32);
        const QChar q = (this->currentAbc == Alphabet::EN) ? this->alphabetEn.at(15) : this->alphabetRu.at(27);
        if (res.length() == 0)
        {
            return acc;
        }
    ...
    void Playfair::generateTable(const QString &key)
    {
        this->table = {};
        QString noDup = "";
        const QString keyAbc = key + (this->currentAbc == Alphabet::EN ? this->alphabetEn : this->alphabetRu);
    ...
    void Playfair::setCurrentAbc(Alphabet a)
    {
        this->currentAbc = a;
    }
